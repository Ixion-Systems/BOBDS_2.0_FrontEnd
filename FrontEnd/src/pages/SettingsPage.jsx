...
const SettingsPage = () => {
  ...
  return (
    <div className="w-full h-full max-w-4xl mx-auto px-4 py-8 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 pb-8 flex flex-col gap-6">
